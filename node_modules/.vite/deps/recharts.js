...
import {
  ...
  time,
  utcTime
} from "./chunk-KTYUERCM.js";
import "./chunk-CMC347K3.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React73 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef20 = React73.useRef, useEffect28 = React73.useEffect, useMemo11 = React73.useMemo, useDebugValue = React73.useDebugValue;
...
var interpolateNumber2 = curry2((a2, b, t) => {
  var newA = +a2;
  var newB = +b;
  return newA + t * (newB - newA);
});
var uninterpolateNumber = curry2((a2, b, x2) => {
  var diff = b - +a2;
  diff = diff || Infinity;
  return (x2 - a2) / diff;
});
var uninterpolateTruncation = curry2((a2, b, x2) => {
  var diff = b - +a2;
  diff = diff || Infinity;
...
var getTickOfSingleValue = (value, tickCount, allowDecimals) => {
  ...
  var fn = compose(map((n) => middle.add(new decimal_default(n - middleIndex).mul(step)).toNumber()), range2);
...
function FunnelLabelListProvider(_ref2) {
  ...
  return React71.createElement(CartesianLabelListContextProvider, {
...
function TrapezoidsWithAnimation(_ref3) {
  ...
  return React71.createElement(FunnelLabelListProvider, {
    showLabels,
    trapezoids
  }, React71.createElement(JavascriptAnimate, {
    animationId,
    begin: animationBegin,
    duration: animationDuration,
    isActive: isAnimationActive,
  ...
  }), React71.createElement(LabelListFromLabelProp, {
    label: props.label
  }), props.children);
}
